  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 text-center">
      <div className="wiki-card p-8">
        ...
        <Link to="/" className="mt-6 inline-block rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm text-muted-foreground hover:text-white">Back to servers</Link>
      </div>
    </main>
  );
}
